...
public final class IOCase implements Serializable
{
	 ...
	 */
	public static final IOCase	SYSTEM				= new IOCase(
															"System",
															!FilenameUtils
																	.isSystemWindows());
	...
	public int checkCompareTo(final String str1, final String str2)
	{
		...
		return this.sensitive ? str1.compareTo(str2) : str1
	...
	public boolean checkEndsWith(final String str, final String end)
	{
		...
		return str.regionMatches(!this.sensitive, str.length() - endLen, end,
				0, endLen);
	}
	 ...
	 * @since 2.0
	 */
	public int checkIndexOf(final String str, final int strStartIndex,
			final String search)
	{
		...
		if (endIndex >= strStartIndex)
		{
			...
			{
				if (this.checkRegionMatches(str, i, search)) { return i; }
			}
		}
		return -1;
	}
	 ...
	 *             if either string is null
	 */
	public boolean checkRegionMatches(final String str,
			final int strStartIndex, final String search)
	{
		return str.regionMatches(!this.sensitive, strStartIndex, search, 0,
				search.length());
	}
