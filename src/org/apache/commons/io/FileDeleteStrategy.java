...
public class FileDeleteStrategy
{
	...
	{
		if (fileToDelete.exists() && (this.doDelete(fileToDelete) == false)) { throw new IOException(
				"Deletion failed: " + fileToDelete); }
	}
	...
	{
		if ((fileToDelete == null) || (fileToDelete.exists() == false)) { return true; }
		try
		{
