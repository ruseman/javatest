...
public class TaggedIOException extends IOExceptionWithCause
{
	 ...
	 */
	public static boolean isTaggedWith(final Throwable throwable,
			final Object tag)
	{
		return (tag != null)
	 ...
	 */
	public static void throwCauseIfTaggedWith(final Throwable throwable,
			final Object tag)
			throws IOException
	{
		if (TaggedIOException.isTaggedWith(throwable, tag)) { throw ((TaggedIOException) throwable)
				.getCause(); }
	}
