...
public class WriterOutputStream extends OutputStream
{
	 ...
	 * decoder.
	 */
	private final ByteBuffer		decoderIn			= ByteBuffer
																.allocate(128);
	...
	public WriterOutputStream(final Writer writer)
	{
		this(writer, Charset.defaultCharset(),
				WriterOutputStream.DEFAULT_BUFFER_SIZE, false);
	}
	 ...
	 */
	public WriterOutputStream(final Writer writer,
			final CharsetDecoder decoder, final int bufferSize,
	...
	private void flushOutput() throws IOException
	{
		...
		{
			this.writer.write(this.decoderOut.array(), 0,
					this.decoderOut.position());
	...
	private void processInput(final boolean endOfInput) throws IOException
	{
		...
		while (true)
		{
			coderResult = this.decoder.decode(this.decoderIn, this.decoderOut,
					endOfInput);
