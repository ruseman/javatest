...
public class FileWriterWithEncoding extends Writer
{
	...
	{
		if (file == null) { throw new NullPointerException("File is missing"); }
	 ...
	 *             in case of an I/O error
	 */
	public FileWriterWithEncoding(final File file, final CharsetEncoder encoding)
			throws IOException
	{
		this(file, encoding, false);
	}
	 ...
	 *             in case of an I/O error
	 */
	public FileWriterWithEncoding(final File file,
			final CharsetEncoder encoding, final boolean append)
			throws IOException
	{
		super();
		this.out = FileWriterWithEncoding.initWriter(file, encoding, append);
	 ...
	 *             in case of an I/O error
	 */
	public FileWriterWithEncoding(final File file, final String encoding)
			throws IOException
	{
		this(file, encoding, false);
	}
	 ...
	 *             in case of an I/O error
	 */
	public FileWriterWithEncoding(final String filename, final Charset encoding)
			throws IOException
	{
	 ...
	 *             in case of an I/O error
	 */
	public FileWriterWithEncoding(final String filename,
	 ...
	 */
	public FileWriterWithEncoding(final String filename,
			final CharsetEncoder encoding) throws IOException
	{
		this(new File(filename), encoding, false);
	}
	 ...
	 *             in case of an I/O error
	 */
	public FileWriterWithEncoding(final String filename, final String encoding)
			throws IOException
	{
		this(new File(filename), encoding, false);
	}
