...
public class LockableFileWriter extends Writer
{
	 ...
	 * @since 2.3
	 */
	public LockableFileWriter(File file, final Charset encoding,
			...
			String lockDir) throws IOException
	{
		...
		this.lockFile = new File(lockDirFile, file.getName()
				+ LockableFileWriter.LCK);
	...
	private void createLock() throws IOException
	{
		...
		{
			if (!this.lockFile.createNewFile()) { throw new IOException(
					"Can't write file, lock " +
	 ...
	 *             if an error occurs
	 */
	private Writer initWriter(final File file, final Charset encoding,
	...
	{
		if (!lockDir.exists()) { throw new IOException(
				"Could not find lockDir: " + lockDir.getAbsolutePath()); }
		if (!lockDir.canWrite()) { throw new IOException(
