		...
		extends ThresholdingOutputStream
{
	 ...
	 *            Temporary file directory.
	 */
	private DeferredFileOutputStream(final int threshold,
			final File outputFile, final String prefix, final String suffix,
	...
	public byte[] getData()
	{
		if (this.memoryOutputStream != null) { return this.memoryOutputStream
				.toByteArray(); }
		return null;
	}
...
// file
		...
		// a file or memory.
		if (!this.closed) { throw new IOException("Stream not closed"); }
	...
	protected void thresholdReached() throws IOException
	{
		if (this.prefix != null)
		{
			this.outputFile = File.createTempFile(this.prefix, this.suffix,
					this.directory);
		}
