...
public class WildcardFilter extends AbstractFileFilter implements Serializable
{
	...
	{
		if (wildcards == null) { throw new IllegalArgumentException(
	...
	{
		if (wildcard == null) { throw new IllegalArgumentException(
	...
	public boolean accept(final File file)
	{
		...
		{
			if (FilenameUtils.wildcardMatch(file.getName(), wildcard)) { return true; }
		}
	...
	{
		if ((dir != null) && new File(dir, name).isDirectory()) { return false; }
		
		for (final String wildcard : this.wildcards)
		{
			if (FilenameUtils.wildcardMatch(name, wildcard)) { return true; }
		}
