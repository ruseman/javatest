		...
		Serializable
{
	...
	{
		if (magicNumber == null) { throw new IllegalArgumentException(
				"The magic number cannot be null"); }
		if (magicNumber.length == 0) { throw new IllegalArgumentException(
...
// charset
	...
	public boolean accept(final File file)
	{
		if ((file != null) && file.isFile() && file.canRead())
		{
			...
			try
			{
				...
				if (read != this.magicNumbers.length) { return false; }
	...
	public String toString()
	{
		...
		builder.append("(");
		builder.append(new String(this.magicNumbers));// TODO perhaps use hex if
