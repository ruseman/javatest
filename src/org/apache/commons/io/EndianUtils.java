...
public class EndianUtils
{
	...
	{
		return Double.longBitsToDouble(EndianUtils
				.readSwappedLong(data, offset));
	}
	...
	{
		return Float.intBitsToFloat(EndianUtils
				.readSwappedInteger(data, offset));
	}
	...
	public static short readSwappedShort(final InputStream input)
			throws IOException
	{
		return (short) (((EndianUtils.read(input) & 0xff) << 0) + ((EndianUtils
				.read(input) & 0xff) << 8));
	}
	 ...
	 * @return the value read
	 */
	public static long readSwappedUnsignedInteger(final byte[] data,
			final int offset)
	{
	 ...
	 * @return the value read
	 */
	public static int readSwappedUnsignedShort(final byte[] data,
			final int offset)
	{
	...
	{
		return Double.longBitsToDouble(EndianUtils.swapLong(Double
	...
	{
		return Float.intBitsToFloat(EndianUtils.swapInteger(Float
	...
	public static void writeSwappedDouble(final byte[] data, final int offset,
			final double value)
	{
		EndianUtils.writeSwappedLong(data, offset,
	 ...
	 *             in case of an I/O problem
	 */
	public static void writeSwappedDouble(final OutputStream output,
			final double value)
			throws IOException
	{
	...
	public static void writeSwappedFloat(final byte[] data, final int offset,
			final float value)
	{
		EndianUtils.writeSwappedInteger(data, offset,
	 ...
	 *             in case of an I/O problem
	 */
	public static void writeSwappedFloat(final OutputStream output,
			final float value)
			throws IOException
	{
	 ...
	 *             in case of an I/O problem
	 */
	public static void writeSwappedInteger(final OutputStream output,
			final int value)
			throws IOException
	{
	 ...
	 *             in case of an I/O problem
	 */
	public static void writeSwappedLong(final OutputStream output,
			final long value)
			throws IOException
	{
		output.write((byte) ((value >> 0) & 0xff));
	 ...
	 *             in case of an I/O problem
	 */
	public static void writeSwappedShort(final OutputStream output,
			final short value)
			throws IOException
	{
		output.write((byte) ((value >> 0) & 0xff));
