...
public final class Question
{
	...
	public static final String SEP_STR = "" + SEP_CHAR;
	...
	{
		this(qstring.split(SEP_STR));
	}
	
	public Question(final String question, final String answer, final String dummy0, final String dummy1, final String dummy2) throws Exception
	{
	...
	public int hashCode()
	{
		...
		result = (prime * result) + ((this.dummy0 == null) ? 0 : this.dummy0.hashCode());
		result = (prime * result) + ((this.dummy1 == null) ? 0 : this.dummy1.hashCode());
		result = (prime * result) + ((this.dummy2 == null) ? 0 : this.dummy2.hashCode());
	...
	{
		return "Question [question=" + this.question + ", answer=" + this.answer + ", dummy0=" + this.dummy0 + ", dummy1=" + this.dummy1 + ", dummy2=" + this.dummy2 + "]";
	}
}
