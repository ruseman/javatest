...
public final class AppFrame extends JFrame
{
	...
	public AppFrame()
	{
		this.setTitle(JTest.getNewTitle());
		...
		btnA.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(final MouseEvent e)
			{
				JTest.getPlayer().choose(JTest.getQuestions().getCurrentQuestion(), Choice.A);
		...
		btnB.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(final MouseEvent e)
			{
				JTest.getPlayer().choose(JTest.getQuestions().getCurrentQuestion(), Choice.B);
				AppFrame.this.refresh();
			}
		});
		...
		btnC.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(final MouseEvent e)
			{
				JTest.getPlayer().choose(JTest.getQuestions().getCurrentQuestion(), Choice.C);
				AppFrame.this.refresh();
			}
		});
		...
		btnD.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(final MouseEvent e)
			{
				JTest.getPlayer().choose(JTest.getQuestions().getCurrentQuestion(), Choice.D);
				AppFrame.this.refresh();
